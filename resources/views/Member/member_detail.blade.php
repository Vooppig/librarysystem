        ...
        <div class="col-sm-6">
            <div class="position-static">
                ...
                <div class="position-absolute top-0 start-0 translate-middle">
                    ...
                    <button class="btn btn-secondary"><a style="color:white" href="{{url('member_orderdetail')}}/{{$book->id}}" @if($book->type==1) echo "hidden" @endif >Түрэслэх</a></button>
                    <button class="btn btn-secondary"><a style="color:white" href="{{url('member_orderbuydetail')}}/{{$book->id}}"> Худалдаж авах</a></button>
                </div>
            </div>
        </div>
    </div>
